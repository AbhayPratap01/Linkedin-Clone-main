...
- Live Preview: [[Link](https://linkedin-clone-main-one.vercel.app/)]
...
```bash
    https://github.com/AbhayPratap01/Linkedin-Clone-main.git
```
...
If you have any feedback, please reach out to me [here](https://abhay-pratap01.vercel.app/)
